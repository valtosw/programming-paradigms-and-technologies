...
*Розбити заданий список на кілька списків, записуючи у перший список значення, які менші за 2^0 , у другий – які менші за 2^1 та не потрапили до попереднього списку, у третій – які менші за 2^2 та не потрапили до двох попередніх списків, у четвертий – які менші за 2^3 та не потрапили до попередніх списків і т.д.*
